...
import asyncio
import pytest
from src.the_risk_is_not_enough.client.alpaca_market_data.alpaca_stream_client import AlpacaStreamClient, DataFeed
...
async def alpaca_client():
    from src.the_risk_is_not_enough.client.alpaca_market_data.alpaca_stream_client import AlpacaStreamClient
