...
from algo_royale.portfolio.portfolio_strategy.inverse_volatility_portfolio_strategy import (
    InverseVolatilityPortfolioStrategy,
)


def test_inverse_volatility_basic():
...
def test_inverse_volatility_all_zero_returns():
    returns = pd.DataFrame(
