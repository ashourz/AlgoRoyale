...
class TestNewsSentimentService(TestCase):
    ...
    def setUp(self, MockNewsSentimentDAO):
        ...
        self.service = NewsSentimentRepo(dao=self.mock_dao)
    ...
    def test_insert_sentiment(self):
        ...
        self.mock_dao.insert_sentiment.assert_called_once_with(
            ...
            "AAPL",
            Decimal("0.75"),
            "Positive news about AAPL",
            "Reuters",
            datetime(2024, 4, 11, 14, 30, 0),
        )
    ...
    def test_update_sentiment(self):
        ...
        self.mock_dao.update_sentiment.assert_called_once_with(
            1,
            Decimal("0.80"),
            "Updated news about AAPL",
            "Bloomberg",
            datetime(2024, 4, 12, 14, 30, 0),
        )
    ...
    def test_fetch_sentiment_by_symbol_and_date(self):
        ...
        self.mock_dao.fetch_sentiment_by_symbol_and_date.return_value = (
            sentiment_records
        )
        result = self.service.get_sentiment_by_symbol_and_date(
            symbol, start_date, end_date
        )
        self.mock_dao.fetch_sentiment_by_symbol_and_date.assert_called_once_with(
            symbol, start_date, end_date
        )
        self.assertEqual(result, sentiment_records)
