...
from algo_royale.services.indicator_service import IndicatorService


def create_indicator_blueprint(service: IndicatorService) -> Blueprint:
    """
    Create a Flask blueprint for indicator routes.
    :param service: An instance of IndicatorService.
    :return: A Flask blueprint with indicator routes.
    """
