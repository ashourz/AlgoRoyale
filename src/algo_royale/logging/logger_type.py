...
class LoggerType(Enum):
    ...
    SIGNAL_STRATEGY = ("SIGNAL_STRATEGY", logging.DEBUG)
    PORTFOLIO_STRATEGY = ("PORTFOLIO_STRATEGY", logging.DEBUG)
    ...
    BACKTEST_DATA_INGEST = ("BACKTEST_DATA_INGEST", logging.DEBUG)
    ...
    SYMBOL_STRATEGY_MANAGER = ("SYMBOL_STRATEGY_MANAGER", logging.DEBUG)
