...
class BufferedMomentumExitCondition(BaseBufferedCondition):
    """
    Buffered Momentum Exit Condition
    Triggers when momentum falls below a threshold, with optional smoothing and confirmation.
    """
