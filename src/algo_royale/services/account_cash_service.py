...
class AccountCashService:
    ...
    def unsettled_cash(self) -> Decimal:
        ...
        return self._total_cash - self._buying_power
    ...
    async def async_update_cash_info(self):
        ...
        try:
            ...
            if account_data:
                self._buying_power = Decimal(account_data.regt_buying_power)
                self._total_cash = Decimal(account_data.cash)
