...
class StockDataService:
    ...
    def get_stock_data_by_symbol_and_date(
        ...
        return self.dao.fetch_stock_data_by_symbol_and_date(
    ...
    def update_stock_data(
        ...
        self.dao.update_stock_data(
            stock_data_id, symbol, timestamp, open_price, high, low, close, volume
        )
