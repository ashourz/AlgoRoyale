...
class AdapterContainer(containers.DeclarativeContainer):
    ...
    news_adapter = providers.Singleton(
        ...
        logger=logger_container.provides_logger(logger_type=LoggerType.NEWS_ADAPTER),
    )

    quote_adapter = providers.Singleton(
        QuoteAdapter,
        client=client_container.alpaca_stock_client,
        logger=logger_container.provides_logger(logger_type=LoggerType.QUOTE_ADAPTER),
    )
    ...
    stream_adapter = providers.Singleton(
        ...
        logger=logger_container.provides_logger(logger_type=LoggerType.STREAM_ADAPTER),
    )
    ...
    account_adapter = providers.Singleton(
        ...
        logger=logger_container.provides_logger(logger_type=LoggerType.ACCOUNT_ADAPTER),
    )

    assets_adapter = providers.Singleton(
        AssetsAdapter,
        client=client_container.alpaca_asset_client,
        logger=logger_container.provides_logger(logger_type=LoggerType.ASSETS_ADAPTER),
    )
    ...
    clock_adapter = providers.Singleton(
        ...
        logger=logger_container.provides_logger(logger_type=LoggerType.CLOCK_ADAPTER),
    )
    ...
    orders_adapter = providers.Singleton(
        ...
        logger=logger_container.provides_logger(logger_type=LoggerType.ORDERS_ADAPTER),
    )
